...
void listOfCommands(){
    ...
    cout<<"mCreating: create new list, merging l1 and l2 with incriasing still existing"<<endl;
    cout<<"mCharge: merge both of lists into the first one"<<endl;
    cout<<"readResF: write resultat to a file"<<endl;
